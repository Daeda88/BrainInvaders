...
SET INCLUDE=%OV_DEP_OPENAL%\include;%OV_DEP_ALUT%\include;%INCLUDE%

SET LIB=%OV_DEP_BOOST%\lib;%LIB%
SET LIB=%OV_DEP_MSSDK%\lib;%LIB%
SET LIB=%OV_DEP_OPENAL%\libs\Win32;%LIB%
SET LIB=%OV_DEP_ALUT%\lib;%LIB%
...
rem echo %OpenViBE_application_designer% >> %OpenViBE_build_order%
rem echo %OpenViBE_application_acquisition_server% >> %OpenViBE_build_order%
rem echo %OpenViBE_application_plugin_inspector% >> %OpenViBE_build_order%
echo %OpenViBE_application_vr_demo% >> %OpenViBE_build_order%
