...
echo @echo off                                                            >  %target_dist%\ov-vr-demo-space-invader.cmd
echo SET OpenViBE_DistRoot=%%CD%%>> %target_dist%\ov-vr-demo-space-invader.cmd
echo pushd ..\scripts                                                     >> %target_dist%\ov-vr-demo-space-invader.cmd
echo call %InitEnvScript%                                                 >> %target_dist%\ov-vr-demo-space-invader.cmd
echo popd                                                                 >> %target_dist%\ov-vr-demo-space-invader.cmd
echo copy share\openvibe-applications\vr-demo\space-invader\resources.cfg-base share\openvibe-applications\vr-demo\space-invader\resources.cfg >> %target_dist%\ov-vr-demo-space-invader.cmd
echo type %OV_DEP_CEGUI%\resources.cfg ^>^> share\openvibe-applications\vr-demo\space-invader\resources.cfg >> %target_dist%\ov-vr-demo-space-invader.cmd
echo cd share\openvibe-applications\vr-demo\space-invader                >> %target_dist%\ov-vr-demo-space-invader.cmd
echo %%OpenViBE_DistRoot%%\bin\OpenViBE-vr-demo-dynamic.exe			      >> %target_dist%\ov-vr-demo-space-invader.cmd
echo cd %%OpenViBE_DistRoot%%                                             >> %target_dist%\ov-vr-demo-space-invader.cmd
echo exit                                                                 >> %target_dist%\ov-vr-demo-space-invader.cmd
